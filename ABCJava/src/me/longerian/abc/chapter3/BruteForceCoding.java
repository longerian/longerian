...
public class BruteForceCoding {
	...
	public static void main(String[] args) throws IOException {
		...
		dos.flush();
		System.out.println("Encoded message: "
				+ byteArrayToDecimalString(bos.toByteArray()));
		ByteArrayInputStream bis = new ByteArrayInputStream(bos.toByteArray());
		DataInputStream dis = new DataInputStream(bis);
		System.out.println("Decoded message: "
				+ dis.readByte() + " " + dis.readShort() + " " + dis.readInt() + " " + dis.readLong());
		
		System.out.println(byteArrayToDecimalString("AldTest".getBytes()));
		System.out.println(byteArrayToDecimalString("AldTest".getBytes("UTF-16")));
		System.out.println(byteArrayToDecimalString("AldTest".getBytes("IBM037")));
	}

 ...
 * </div>
 */
public class AppSearchRecentSuggestion {
    // debugging support
     ...
     */
    public AppSearchRecentSuggestion(Context context, String authority, int mode) {
    ...
    public Cursor getQueryHistory() {
    	 ContentResolver cr = mContext.getContentResolver();
    	 return cr.query(mSuggestionsUri, null, null, null, null);
    }

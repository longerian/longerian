...
public class BruteForceCoding {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println(byteArrayToDecimalString("Test".getBytes()));
		System.out.println(byteArrayToDecimalString("Test".getBytes("UTF-16")));
		System.out.println(byteArrayToDecimalString("Test".getBytes("IBM037")));
	}
